...
public class RadiantgemsModBlockEntities {
	public static final DeferredRegister<BlockEntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES,
			RadiantgemsMod.MODID);
	public static final RegistryObject<BlockEntityType<?>> GEODE_SMASHER = register("geode_smasher", RadiantgemsModBlocks.GEODE_SMASHER,
			GeodeSmasherBlockEntity::new);
